...
const Batery: React.FC<BatteryProps> = ({ data }) => {
  return (
    ...
    `}
        ...
        <path
          className="b1"
          d="M1995 2335.84h-822c-25.96 0-47-21.04-47-47v-1362c0-25.96 21.04-47 47-47h822c25.96 0 47 21.04 47 47v1362c0 25.96-21.04 47-47 47z"
        />
        <path
          className="b2"
          d="M2042 1243.84h-916v-311c0-29.28 23.72-53 53-53h810c29.28 0 53 23.72 53 53v311z"
        />
        <rect
          className="b3"
          x="1753.88"
      ...
      <Handle
        ...
        id={data?.first?.pintype as HandleType}
        style={{
          left: "108%",
          top: "49px",
          background: "red",
      ...
      <Handle
        type={data?.second?.type as HandleType}
        position={Position.Top}
        id={data?.second?.pintype as HandleType}
        style={{
          left: "143%",
          top: "49px",
          background: "black",

    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
      <div className="w-full max-w-6xl bg-gray-800 rounded-2xl shadow-2xl flex overflow-hidden">
        ...
        <div className="w-full md:w-1/2 p-8">
          ...
          {currentPage === "verify-forgot-password" && (
          ...
          {currentPage === "reset-password" && (
            <ResetPassword onPageChange={handlePageChange} />
          )}
          {currentPage === "otp-verifyEmail" && (
            <OtpVerifyEmail email={email} onPageChange={handlePageChange} />
          )}
        </div>
